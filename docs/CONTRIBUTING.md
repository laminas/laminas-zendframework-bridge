...
[create a proposal](https://github.com/laminas/laminas-zendframework-bridge/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/laminas/laminas-zendframework-bridge.git
  $ cd laminas-zendframework-bridge
  ```
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/laminas-zendframework-bridge.git
   $ git fetch {username}
   ```
